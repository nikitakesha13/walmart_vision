...
#---------------------------------------------------------------
    ...
    def HMFactor(self, horizontialDist):
    ...
    def VMFactor(self, verticalDist):
    ...
    def couplingMultiplier(self, CM):
        if CM == "Good":
            return 1.0
        elif CM == "Fair":
            return 2.0
...
#---------------------------------------------------------------
    ...
    def get_spine_length(self, frame):
        tailbone = ((frame["Lhip"][0] + frame["Rhip"][0]) / 2, (frame["Lhip"][1] + frame["Rhip"][1]) / 2)
        return self.distance(tailbone, frame["neck"])